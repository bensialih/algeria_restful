...
var main = new Vue({
    ...
    methods: {
        wilayaChange: function wilayaChange() {
        ...
        communeChange: function communeChange() {
        ...
        toggleIntro: function toggleIntro() {
            this.introduction = !this.introduction;
        },
        generateQueryGeneralSearch: function generateQueryGeneralSearch() {
        ...
        generateQueryWilayaSearch: function generateQueryWilayaSearch() {
        ...
        generateQueryCommuneSearch: function generateQueryCommuneSearch() {
        ...
        searchCommune: function searchCommune() {
...
},{"vue":27,"vue-resource":16}],2:[function(require,module,exports){
